            ...
            <div class="row p-t-b-10 ">
             ...
             <div class="row justify-content-between">
                <ul role="tablist" class="nav nav-material nav-material-white responsive-tab">
                    <li class="nav-item">
                        <a class="nav-link show" id="tab1" href="{{ route('config.opd.index') }}"><i class="icon icon-arrow-left"></i>Kembali</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-8 mb-5-m">
                <div class="card no-b">
                    <input type="hidden" id="opd_filter" value="{{ $opd_id }}">
                    <div class="card-header bg-white font-weight-bold"><i class="icon icon-clipboard-list text-primary mr-2"></i>{{ $opd->nama }}</div>
                    <div class="card-body">
                ...
                <div class="card no-b">
                    <div class="card-body">
                        <form class="needs-validation" id="form" method="POST" novalidate>
                            ...
                            <input type="hidden" id="id_opd" name="id_opd" value="{{ $opd_id }}"/>
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'nama', name: 'nama'},
            {data: 'total_sub_bidang', name: 'total_sub_bidang', className: 'text-center'},
