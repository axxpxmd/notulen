                        ...
                        <form class="needs-validation" id="form" method="POST" novalidate>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9">
                                        <textarea type="text" name="nama" id="nama" placeholder="Nama Dinas / Instansi" rows="4" class="form-control r-0 s-12" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-2">
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'nama', name: 'nama'},
            {data: 'total_bidang', name: 'total_bidang', className: 'text-center'},
